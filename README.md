...
The SDA and SCL is always  pulled down (0v) through the Screen (Means it refuses any external communication). I got confused after I turned off the controller and powered the screen from the Arduino It reads 0.7v not 0v. This ensures that the lcd screen closes this port.
